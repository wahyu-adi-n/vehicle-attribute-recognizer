...
def metrics_report_to_df(y_true, y_pred, dir_path):
    ...
    classification_report.loc['avg/Total', :] = precision_recall_fscore_support(y_true, y_pred, average='macro')
    ...
    classification_report.to_csv(dir_path + f'classification_report.csv', encoding='utf-8')
